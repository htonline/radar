...
//    private TextView tv_dqid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wifiAdmin = new WifiTool(MyDialogActivity.this);
...
//        Toast.makeText(MyDialogActivity.this,filepath+"",Toast.LENGTH_SHORT).show();
        textView = (TextView) findViewById(R.id.tv_pathoffile);
        btn_chosePath = findViewById(R.id.my_dialog_addFile);
        ib_scan = findViewById(R.id.iv_scanicon);
        ib_upload_file = findViewById(R.id.ib_uploadFile);
        tv_cxbh = findViewById(R.id.tv_cxbh);
        tv_cxorient = findViewById(R.id.tv_cxorient);
        tv_cxstart = findViewById(R.id.tv_cxstart);
        tv_cxstop = findViewById(R.id.tv_cxstop);
//        tv_dqid = findViewById(R.id.tv_dqid);
        tv_dqbh = findViewById(R.id.tv_dqbh);
        tv_dqheight = findViewById(R.id.tv_dqheight);
        tv_dqthk = findViewById(R.id.tv_dqthk);
        tv_dqtype = findViewById(R.id.tv_dqtype);
        tv_dqwidth = findViewById(R.id.tv_dqwidth);
        tv_dqloc = findViewById(R.id.tv_dqloc);
        et_detect_username = findViewById(R.id.et_detect_username);
        et_mainServerNum = findViewById(R.id.et_mainServerNum);
        et_remark = findViewById(R.id.et_remark);
        ib_login = findViewById(R.id.ib_login);

        ib_upload_img_01 = findViewById(R.id.ib_upload_pic_01);
        ib_upload_img_02 = findViewById(R.id.ib_upload_pic_02);
        ib_upload_img_03 = findViewById(R.id.ib_upload_pic_03);
...
//                wifiAdmin.closeWifi();
                Toast.makeText(MyDialogActivity.this,"请确认连接正常功能的wifi",Toast.LENGTH_SHORT).show();
        ...
        ib_upload_img_01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MyDialogActivity.this, SelectPicActivity.class);
                if (user_token != null) {
                    intent.putExtra("token", user_token);
                    startActivityForResult(intent, TO_SELECT_PHOTO);
                    choseImgUp = 1;
                } else Toast.makeText(MyDialogActivity.this, "请先登录", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(MyDialogActivity.this,"wifi已打开",Toast.LENGTH_SHORT).show();
        ...
        abtn_my_dialog_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (user_token == null) {
                    Toast.makeText(MyDialogActivity.this, "请先点击左上角登录", Toast.LENGTH_SHORT).show();

                } else if (tv_cxstart.getText().toString() == "") {
                    Toast.makeText(MyDialogActivity.this, "请先扫描二维码填入基本信息！", Toast.LENGTH_SHORT).show();
                } else if (tag_is_uploadraw == 0) {
                    Toast.makeText(MyDialogActivity.this, "请上传雷达数据", Toast.LENGTH_SHORT).show();
                } else if (tag_is_uploadimg01 == 0 || tag_is_uploadimg02 == 0 || tag_is_uploadimg03 == 0) {
                    Toast.makeText(MyDialogActivity.this, "请上传完整3张现场图片", Toast.LENGTH_SHORT).show();
                } else {
                    runFirst();
                    initHttpDQTask();
...
//                Log.d(TAG,textView.getText().toString().length()+"-----------");
                if (user_token != null) {
                    if (textView.getText().toString().length() < 3) {
                        Toast.makeText(MyDialogActivity.this, "请选择雷达数据", Toast.LENGTH_SHORT).show();
                    } else {
                        initTask();
        ...
        btn_chosePath.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = FileListMyDialogManager.actionStart(MyDialogActivity.this, filepath);
        ...
        ib_scan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MyDialogActivity.this, CaptureActivity.class);
...
//                }
            ...
            protected void onPostExecute(Object o) {
                ...
                if (o.toString().indexOf("Bearer") != -1) {
                    ...
                    Toast.makeText(MyDialogActivity.this, o.toString(), Toast.LENGTH_SHORT).show();
            }
        };
    }
...
//                }
            ...
            protected void onPostExecute(Object o) {
                ...
                if (o.toString() == String.valueOf(1)) {
                    Toast.makeText(MyDialogActivity.this, "上传成功!", Toast.LENGTH_SHORT).show();
...
//                Log.d(TAG, urlString);
                if (user_token == "") {
                    Toast.makeText(MyDialogActivity.this, "请先登录", Toast.LENGTH_SHORT).show();
                }
            ...
            protected void onPreExecute() {
                ...
                Toast.makeText(MyDialogActivity.this, "开始上传", Toast.LENGTH_SHORT).show();
            }
            ...
            protected void onPostExecute(Object o) {
                ...
                if (o.toString().indexOf("avatar") != 0) {
                    ...
                    Toast.makeText(MyDialogActivity.this, (o == null ? "" : o.toString()), Toast.LENGTH_SHORT).show();
            }
        };
    }
}
